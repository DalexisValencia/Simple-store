...
class BottomNavigatorBarInApp extends StatelessWidget {
  ...
  goToLocarton(context, name) {
    Navigator.pushNamed(
        context, name); // Navigator.pushNamed(context, '/detail');
  }
                  ...
                  Expanded(
                    child: activeIndex == 1
                        ...
                        : ItemBottomNavigatorInactive(
                            icon: Icons.home,
                            onTapFunction: () => goToLocarton(context, '/'),
                          ),
                  ),
                  Expanded(
                    child: activeIndex == 2
                        ...
                        : ItemBottomNavigatorInactive(
                            icon: Icons.store,
                            onTapFunction: () =>
                                goToLocarton(context, '/products'),
                          ),
                  ),
                  Expanded(
                    child: activeIndex == 3
                        ? ItemBottomNavigatorBarActive(
                            text: 'Info', icon: Icons.apps)
                        : ItemBottomNavigatorInactive(
                            icon: Icons.apps,
                            onTapFunction: () =>
                                goToLocarton(context, '/detail'),
                          ),
                  ),
                  Expanded(
                    child: activeIndex == 4
