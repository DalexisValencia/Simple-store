              ...
              children:<Widget>[
                Expanded(
                  ...
                  CustomRaisedButton(
                    ...
                    borderColor: activeButton == 'delivery' ? activeColor : inactiveBorderColor,
                    splashColor: activeButton == 'delivery' ? Theme.of(context).primaryColorLight : Theme.of(context).textSelectionColor,
                    ...
                    child: Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 14,
                          color: activeButton == 'delivery' ? Theme.of(context).primaryColorLight : Theme.of(context).textSelectionColor,
                        ),
                      ),
                    ),
                  ),
                ...
                Expanded(
                  ...
                  CustomRaisedButton(
                    ...
                    borderColor: activeButton == 'pick' ? activeColor : inactiveBorderColor,
                    splashColor: activeButton == 'pick' ? Theme.of(context).primaryColorLight : Theme.of(context).textSelectionColor,
                    padding: EdgeInsets.all(6),
                    function: (){
                      setStateButton('pick');
                    },
                    child: Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 14,
                          color: activeButton == 'pick' ? Theme.of(context).primaryColorLight : Theme.of(context).textSelectionColor,
                        ),
                      ),
                    ),
                  ),
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          title: Text("pick your order at", style: Theme.of(context).textTheme.caption),
          subtitle: Text("Your Address", style: Theme.of(context).textTheme.title.copyWith(fontWeight: FontWeight.bold),),
          trailing: Container(
            width: 40,
            height: 40,
            child: CustomRaisedButton(
...
class CardBoxesState extends State<CardBoxes>{
  ...
  Widget build(BuildContext context) {
    return Row(
     children: <Widget>[
      Expanded(
        child: CardBoxItem(title: "Felicidades", icon: Icons.card_giftcard, function: (){} )
      ),
      Expanded(
        child: CardBoxItem(title: "Coupons", icon: Icons.turned_in, function: (){} )
      ),
      Expanded(
        child: CardBoxItem(title: "Quick Scan", icon: Icons.blur_on, function: (){} )
      ),
     ],
    );
  }
